...
const Admin = () => {
    ...
    const [userData, setUserInput, userInput, NewData] = useFirebaseFirestore(imageFile)
        ...
        <div action="">
            <div className='admin'>
                    ...
                    <div className="box">
                        ...
                        <div className="price">
                            ...
                            <div>
                                ...
                                <input type="number" onChange={(e) => setUserInput({ ...userInput, Age: e.target.value })} />
                            </div>
                        </div>
                        ...
                        <div className="btn">
                            <button onClick={NewData} className='button' >New Data</button>
                        </div>
                    </div>
                </div>
                ...
                <div className="right">
                    ...
                    {
                        userData.map(item => (
                            <div className="user" key={item.id} style={{ border: "2px solid #000" }}>
                                <li><span>{item.Name}</span></li>
                                <li><span>{item.Age}</span></li>
                                <li><span>{item.id}</span></li>
                                <img width="300px" height="300px" style={{ objectFit: "cover" }} src={item.ImgUrl} alt="" />
                            </div>
                        ))
                    }
